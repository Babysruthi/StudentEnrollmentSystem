...
public class EnrollmentController {
	...
	public List<Long> getStudents(@PathVariable("code") String code,@PathVariable("staffId") Long staffId) throws StaffIdNotFoundException, CourseCodeNotFoundException //throws RollNoNotFoundException, CourseCodeNotFoundException, StaffIdNotFoundException
	{
