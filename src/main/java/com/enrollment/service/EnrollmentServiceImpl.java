...
public class EnrollmentServiceImpl implements EnrollmentService{
	...
	public List<Long>getStudents( String code, Long staffId) throws StaffIdNotFoundException, CourseCodeNotFoundException, StaffIdNotFoundException {
		...
		if(!staffRepository.existsById(staffId))
		{
		 ...
		 List<Long>students=enrollmentRepository.getStudents(code,staffId);
		 return students;
	}
